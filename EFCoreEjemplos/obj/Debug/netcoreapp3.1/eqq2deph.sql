...
CREATE TABLE [EstudiantesCursos] (
    ...
    CONSTRAINT [PK_EstudiantesCursos] PRIMARY KEY ([CursoId], [EstudianteId]),
    CONSTRAINT [FK_EstudiantesCursos_Cursos_CursoId] FOREIGN KEY ([CursoId]) REFERENCES [Cursos] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_EstudiantesCursos_Estudiantes_EstudianteId] FOREIGN KEY ([EstudianteId]) REFERENCES [Estudiantes] ([Id]) ON DELETE CASCADE
);
GO

CREATE INDEX [IX_EstudiantesCursos_EstudianteId] ON [EstudiantesCursos] ([EstudianteId]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210126030229_EstudianteCurso', N'5.0.2');
GO
